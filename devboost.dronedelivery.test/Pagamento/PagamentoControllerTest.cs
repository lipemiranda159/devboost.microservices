...
using System.Linq;
using Xunit;
using pagamento = devboost.dronedelivery.pagamento.facade;
...
namespace devboost.Dronedelivery.Pagamento.Test
{
    public class PagamentoControllerTest
    {
        ...
        {
            pagamento.PagamentoFacade pagamentoFacade = new pagamento.PagamentoFacade(_pagamentoRepository, _pagamentoIntegration);
